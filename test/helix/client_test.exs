defmodule Helix.ClientTest do
  use ExUnit.Case
  doctest Helix.Client
  ...
  test "setting TWITCH_ENDPOINT overrides the default endpoint" do
    ...
    %{auth: _, endpoint: endpoint} = Helix.Client.new()
  ...
  test "new/0 raises error when missing TWITCH_CLIENT_ID" do
    ...
    assert_raise ArgumentError, error, fn -> Helix.Client.new() end
  end
  ...
  test "new/1 raises ArgumentError when nil :client_id" do
    ...
    assert_raise ArgumentError, error, fn -> Helix.Client.new(auth) end
  end
